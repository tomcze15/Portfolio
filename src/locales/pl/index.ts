export default {
  ...
  ABOUT_ME: [
    ...
    'Aktualnie przeznaczam czas na rozwijanie się pod względem technologii webowych. Chciałbym doskonalić swoje umiejętności w profesjonalnym zespole, a każde nowe wyzwanie pozwoli mi zwiększyć kompetencje.',
  ],
  BUTTON: {
    LONG: 'Pobierz CV',
    SHORT: 'CV',
  ...
  PROJECTS: {
    FIRST: {
      ...
      TECHNOLOGIES: 'Technologie z których korzystałem',
      PERIOD: 'miesiące',
    },
    SECOND: {
  ...
  ICONS_ALT: {
    BURGERBUTTON: 'Przycisk menu',
    DOWNLOAD: 'Chmura z strzałką',
  },
  LOGO: 'Logo',
  CONTACT_DETAILS: 'Dane kontaktowe',
  SOCIAL_ACCOUNT: 'Konto społecznościowe',
  EXIT: 'Wyjście',
  CAR_PANEL: 'Panel samochodowy',
  LIST: 'Lista zadań',
  CLOCK: 'Zegar',
  EARTH: 'Ziemia',
  CAR: 'Samochód',
  TECHNOLOGY: 'Ikona technologii',
  AUTHOR_PHOTO: 'Zdjęcie Tomasza Czerwińskiego',
};
