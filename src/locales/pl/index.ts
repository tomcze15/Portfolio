export default {
  ...
  LINKS: 'Odnośniki',
  ABOUT_ME: {
    P1: 'Mam na imię Tomasz Czerwiński mam 24 lata i pochodzę ze Szczecina. Zawodowo zajmuje się programowaniem, a obecnie jestem frontend developerem. Chciałbym przedstawić swoją streszczoną historię jak do tego doszło.',
    P2: 'Moja przygoda z programowaniem zaczęła się prozaicznie od gier komputerowych, ale poszukiwałem czegoś więcej niż tylko bezproduktywna rozrywka, dlatego od dawna interesował mnie sposób, w jaki moje gry zostały stworzone. Z biegem czasu wachlarz moich zainteresowań poszerzał się i zacząłem interesować się światem webdeveloperki. Zdeterminowało to mój wybór szkół i dlatego ukończyłem technikum Informatyczne SCI z tytułem technika informatyka oraz ukończyłem studia informatyczne na Akademii Morskiej z tytułem inżyniera. To wszystko przyczyniło się do fascynacji związanej z tworzeniem nowego oprogramowania, aplikacji desktopowych oraz webowych i oczywiście gier. Już w trakcie kończenia studiów zostałem przyjęty na staż do globalnej firmy gdzie chwilę po stażu wraz z moimi umiejętnościami trafiłem do profesjonalnego projektu, gdzie głównym jego celem było projektowanie panelu do samochodów elektrycznych z jednego większych producentów w ameryce.',
